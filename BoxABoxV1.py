...
shop0 = Button(root,
               ...
               padx=20,
               pady=10,
               command=lambda: buy(price=0, set=10, name="S0", obj=shop0))
shop1 = Button(root,
               text="5$ for speed 20",
               bg="Black",
               fg="White",
               padx=20,
               pady=10,
               command=lambda: buy(price=5, set=20, name="S1", obj=shop1))
shop2 = Button(root,
               ...
               padx=20,
               pady=10,
               command=lambda: buy(price=10, set=40, name="S2", obj=shop2))
shop3 = Button(root,
               ...
               padx=20,
               pady=10,
               command=lambda: buy(price=15, set=60, name="S3", obj=shop3))
shop4 = Button(root,
               ...
               padx=20,
               pady=10,
               command=lambda: buy(price=20, set=80, name="S4", obj=shop4))
shop5 = Button(root,
               ...
               padx=20,
               pady=10,
               command=lambda: buy(price=25, set=100, name="S5", obj=shop5))
